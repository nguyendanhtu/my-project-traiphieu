...
Partial Public Class DS_HT_NGUOI_SU_DUNG
    ...
    Partial Public Class HT_NGUOI_SU_DUNGDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddHT_NGUOI_SU_DUNGRow(ByVal TEN_TRUY_CAP As String, ByVal TEN As String, ByVal MAT_KHAU As String, ByVal NGAY_TAO As Date, ByVal NGUOI_TAO As String, ByVal TRANG_THAI As String, ByVal BUILT_IN_YN As String, ByVal ID_NHOM_NGUOI_DUNG As Decimal) As HT_NGUOI_SU_DUNGRow
            Dim rowHT_NGUOI_SU_DUNGRow As HT_NGUOI_SU_DUNGRow = CType(Me.NewRow,HT_NGUOI_SU_DUNGRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, TEN_TRUY_CAP, TEN, MAT_KHAU, NGAY_TAO, NGUOI_TAO, TRANG_THAI, BUILT_IN_YN, ID_NHOM_NGUOI_DUNG}
    ...
    Partial Public Class HT_NGUOI_SU_DUNGTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[HT_NGUOI_SU_DUNG] WHERE (([ID] = @Original_ID) AND ([TEN_TRUY_"& _ 
                ...
                "riginal_BUILT_IN_YN) AND ([ID_NHOM_NGUOI_DUNG] = @Original_ID_NHOM_NGUOI_DUNG))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[HT_NGUOI_SU_DUNG] ([TEN_TRUY_CAP], [TEN], [MAT_KHAU], [NGAY_TA"& _ 
                "O], [NGUOI_TAO], [TRANG_THAI], [BUILT_IN_YN], [ID_NHOM_NGUOI_DUNG]) VALUES (@TEN"& _ 
                "_TRUY_CAP, @TEN, @MAT_KHAU, @NGAY_TAO, @NGUOI_TAO, @TRANG_THAI, @BUILT_IN_YN, @I"& _ 
                "D_NHOM_NGUOI_DUNG);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT ID, TEN_TRUY_CAP, TEN, MAT_KHAU, NGAY_TAO, NGUOI_TAO"& _ 
                ", TRANG_THAI, BUILT_IN_YN, ID_NHOM_NGUOI_DUNG FROM HT_NGUOI_SU_DUNG WHERE (ID = "& _ 
                "SCOPE_IDENTITY())"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[HT_NGUOI_SU_DUNG] SET [TEN_TRUY_CAP] = @TEN_TRUY_CAP, [TEN] = @TEN,"& _ 
                ...
                "NHOM_NGUOI_DUNG WHERE (([ID] = @Original_ID) AND ([TEN_TRUY_CAP] = @Original_TEN"& _ 
                "_TRUY_CAP) AND ([TEN] = @Original_TEN) AND ([MAT_KHAU] = @Original_MAT_KHAU) AND"& _ 
                " ([NGAY_TAO] = @Original_NGAY_TAO) AND ([NGUOI_TAO] = @Original_NGUOI_TAO) AND ("& _ 
                "[TRANG_THAI] = @Original_TRANG_THAI) AND ([BUILT_IN_YN] = @Original_BUILT_IN_YN)"& _ 
                " AND ([ID_NHOM_NGUOI_DUNG] = @Original_ID_NHOM_NGUOI_DUNG));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT ID, TEN_TRU"& _ 
                "Y_CAP, TEN, MAT_KHAU, NGAY_TAO, NGUOI_TAO, TRANG_THAI, BUILT_IN_YN, ID_NHOM_NGUO"& _ 
                "I_DUNG FROM HT_NGUOI_SU_DUNG WHERE (ID = @ID)"
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.IP.Core.IPData.My.MySettings.Default.QuanLyPhatHanhTraiPhieuConnectionString1
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT ID, TEN_TRUY_CAP, TEN, MAT_KHAU, NGAY_TAO, NGUOI_TAO, TRANG_THAI, BUILT_IN"& _ 
                "_YN, ID_NHOM_NGUOI_DUNG FROM dbo.HT_NGUOI_SU_DUNG"
        ...
        Public Overloads Overridable Function Insert(ByVal TEN_TRUY_CAP As String, ByVal TEN As String, ByVal MAT_KHAU As String, ByVal NGAY_TAO As Date, ByVal NGUOI_TAO As String, ByVal TRANG_THAI As String, ByVal BUILT_IN_YN As String, ByVal ID_NHOM_NGUOI_DUNG As Decimal) As Integer
        ...
        Public Overloads Overridable Function Update( _
            ...
            If (Original_TEN_TRUY_CAP Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_TEN_TRUY_CAP")
            Else
                Me.Adapter.UpdateCommand.Parameters(9).Value = CType(Original_TEN_TRUY_CAP,String)
            End If
            If (Original_TEN Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_TEN")
            Else
            ...
            End If
            Me.Adapter.UpdateCommand.Parameters(12).Value = CType(Original_NGAY_TAO,Date)
            If (Original_NGUOI_TAO Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_NGUOI_TAO")
            Else
                Me.Adapter.UpdateCommand.Parameters(13).Value = CType(Original_NGUOI_TAO,String)
            End If
            If (Original_TRANG_THAI Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_TRANG_THAI")
            Else
                Me.Adapter.UpdateCommand.Parameters(14).Value = CType(Original_TRANG_THAI,String)
            End If
            If (Original_BUILT_IN_YN Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_BUILT_IN_YN")
            Else
                Me.Adapter.UpdateCommand.Parameters(15).Value = CType(Original_BUILT_IN_YN,String)
            End If
            Me.Adapter.UpdateCommand.Parameters(16).Value = CType(Original_ID_NHOM_NGUOI_DUNG,Decimal)
            Me.Adapter.UpdateCommand.Parameters(17).Value = CType(ID,Decimal)
        ...
        Public Overloads Overridable Function Update( _
                    ...
                    ByVal Original_TRANG_THAI As String,  _
                    ByVal Original_BUILT_IN_YN As String,  _
                    ByVal Original_ID_NHOM_NGUOI_DUNG As Decimal) As Integer
            Return Me.Update(TEN_TRUY_CAP, TEN, MAT_KHAU, NGAY_TAO, NGUOI_TAO, TRANG_THAI, BUILT_IN_YN, ID_NHOM_NGUOI_DUNG, Original_ID, Original_TEN_TRUY_CAP, Original_TEN, Original_MAT_KHAU, Original_NGAY_TAO, Original_NGUOI_TAO, Original_TRANG_THAI, Original_BUILT_IN_YN, Original_ID_NHOM_NGUOI_DUNG, Original_ID)
        End Function
    End Class
End Namespace

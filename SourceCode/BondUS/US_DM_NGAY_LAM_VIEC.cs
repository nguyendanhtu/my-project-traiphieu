...
#region "Init Functions"
        ...
        string ip_str_ngay_lam_viec_26_YN)
    {
        ...
        v_pr_obj.addDatetimeInputParam("@NGAY_THANH_TOAN", ip_ngay_thanh_toan.Date);
    ...
    public void FillDatasetGetNgayThanhToan(
        DS_DM_NGAY_LAM_VIEC ip_ds_dm_ng_lam_viec,
        DateTime ip_ngay_chot_lai,
        decimal ip_dc_so_ngay_chot_lai_truoc_ngay_thanh_toan,
        string ip_str_ngay_lam_viec_26_YN)
    {
        CStoredProc v_pr_obj = new CStoredProc("pr_DM_NGAY_LAM_VIEC_get_ngay_thanh_toan");

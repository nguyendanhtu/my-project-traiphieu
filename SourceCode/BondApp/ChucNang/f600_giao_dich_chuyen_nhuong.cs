...
namespace BondApp
{
    public partial class f600_giao_dich_chuyen_nhuong : Form
    {
        ...
        private void us_trai_phieu_2_form(US_V_DM_TRAI_PHIEU ip_us_trai_phieu)
        {
            ...
            m_txt_lai_suat.Text = CIPConvert.ToStr(ip_us_trai_phieu.dcLAI_SUAT_DEFAULT * 100, "#,##0.####");
        ...
        private void us_dg_chuyen_nhuong_2_from()
        {
            ...
            else m_txt_ty_le_phi_gd.Text = CIPConvert.ToStr(m_us_gd_chuyen_nhuong.dcTY_LE_PHI_GD*100, "#,##0.####");            
            ...
            else m_txt_phan_tram_thue.Text = CIPConvert.ToStr(m_us_gd_chuyen_nhuong.dcPHAN_TRAM_THUE * 100, "#,##0.####");

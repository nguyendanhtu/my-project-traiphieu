...
/// Goal: Create Form for V_GD_NHAC_VIEC
///************************************************
...
,
		...
		DS_V_GD_NHAC_VIEC m_ds = new DS_V_GD_NHAC_VIEC();
		US_V_GD_NHAC_VIEC m_us = new US_V_GD_NHAC_VIEC();
		#endregion
		...
		private ITransferDataRow get_trans_object(C1.Win.C1FlexGrid.C1FlexGrid i_fg){
            ...
            v_htb.Add(V_GD_NHAC_VIEC.NGAY, e_col_Number.NGAY);
		...
		private void insert_V_GD_NHAC_VIEC(){			
		//	f800_rpt_nhac_viec_DE v_fDE = new  f800_rpt_nhac_viec_DE();								
		//	v_fDE.display();
			load_data_2_grid();
		}

		private void update_V_GD_NHAC_VIEC(){			
		...
		private void delete_V_GD_NHAC_VIEC(){
			if (!CGridUtils.IsThere_Any_NonFixed_Row(m_fg)) return;
			if (!CGridUtils.isValid_NonFixed_RowIndex(m_fg, m_fg.Row)) return;
			if (BaseMessages.askUser_DataCouldBeDeleted(8) != BaseMessages.IsDataCouldBeDeleted.CouldBeDeleted)  return;
			US_V_GD_NHAC_VIEC v_us = new US_V_GD_NHAC_VIEC();
		...
		private void view_V_GD_NHAC_VIEC(){			
			if (!CGridUtils.IsThere_Any_NonFixed_Row(m_fg)) return;
			if (!CGridUtils.isValid_NonFixed_RowIndex(m_fg, m_fg.Row)) return;
			grid2us_object(m_us, m_fg.Row);
		//	f800_rpt_nhac_viec_DE v_fDE = new f800_rpt_nhac_viec_DE();			
        ...
        private void set_define_events(){
            ...
            this.KeyDown += new KeyEventHandler(f800_rpt_nhac_viec_KeyDown);
		}

        void f800_rpt_nhac_viec_KeyDown(object sender, KeyEventArgs e)
        {
            try
            {

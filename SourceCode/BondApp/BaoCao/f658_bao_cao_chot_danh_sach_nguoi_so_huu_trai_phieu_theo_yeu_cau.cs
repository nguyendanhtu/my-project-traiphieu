...
namespace BondApp
{
	...
	public class f658_bao_cao_chot_danh_sach_nguoi_so_huu_trai_phieu_theo_yeu_cau : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(f658_bao_cao_chot_danh_sach_nguoi_so_huu_trai_phieu_theo_yeu_cau));
			...
			// m_fg
			// 
			this.m_fg.ColumnInfo = @"9,1,0,0,0,85,Columns:0{Width:13;}	 3{Caption:""Số CMT/ĐKKD"";Visible:True;DataType:System.String;TextAlign:LeftCenter;TextAlignFixed:CenterCenter;}2{Caption:""Tên trái chủ"";Visible:True;DataType:System.String;TextAlign:LeftCenter;TextAlignFixed:CenterCenter;}7{Caption:""Số lượng trái phiếu sở hữu"";Visible:True;DataType:System.Decimal;TextAlign:RightCenter;TextAlignFixed:CenterCenter;}4{Caption:""Ngày cấp"";Visible:True;DataType:System.Decimal;TextAlign:RightCenter;TextAlignFixed:CenterCenter;}1{Caption:""Mã trái chủ"";Visible:True;DataType:System.String;TextAlign:LeftCenter;TextAlignFixed:CenterCenter;}6{Caption:""Địa chỉ"";Visible:True;DataType:System.String;TextAlign:LeftCenter;TextAlignFixed:CenterCenter;}8{Caption:""Giá trị trái phiêu sở hữu"";Visible:True;DataType:System.Decimal;TextAlign:RightCenter;TextAlignFixed:CenterCenter;}5{Caption:""Nơi cấp"";Visible:True;DataType:System.String;TextAlign:LeftCenter;TextAlignFixed:CenterCenter;}	";
			...
			this.Text = "f658_bao_cao_chot_danh_sach_nguoi_so_huu_trai_phieu_theo_yeu_cau";
...
,NOI_CAP_CMT = 5
		...
		private void insert_v_dm_trai_chu(){			
		//	f658_bao_cao_chot_danh_sach_nguoi_so_huu_trai_phieu_theo_yeu_cau_DE v_fDE = new  f658_bao_cao_chot_danh_sach_nguoi_so_huu_trai_phieu_theo_yeu_cau_DE();								
		//	v_fDE.display();
			load_data_2_grid();
		}

		private void update_v_dm_trai_chu(){			
		...
		private void delete_v_dm_trai_chu(){
			if (!CGridUtils.IsThere_Any_NonFixed_Row(m_fg)) return;
			if (!CGridUtils.isValid_NonFixed_RowIndex(m_fg, m_fg.Row)) return;
		...
		private void view_v_dm_trai_chu(){			
			if (!CGridUtils.IsThere_Any_NonFixed_Row(m_fg)) return;
			if (!CGridUtils.isValid_NonFixed_RowIndex(m_fg, m_fg.Row)) return;
			grid2us_object(m_us, m_fg.Row);
		//	f658_bao_cao_chot_danh_sach_nguoi_so_huu_trai_phieu_theo_yeu_cau_DE v_fDE = new f658_bao_cao_chot_danh_sach_nguoi_so_huu_trai_phieu_theo_yeu_cau_DE();			

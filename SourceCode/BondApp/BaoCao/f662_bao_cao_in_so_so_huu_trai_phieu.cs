...
,
        ...
        private void export_excel()
        {
            ...
            CExcelReport v_obj_export_excel1 = new CExcelReport("f500_DLDKLK_So_DKNSHTP.xls", 8, 3);
...
//            v_obj_export_excel1.AddFindAndReplaceItem("<DOT_PHAT_HANH>", CIPConvert.ToStr(v_us_dot_phat_hanh.dcLAN_THU, "#,###"));  
            ...
            v_obj_export_excel1.FindAndReplace();
            //
            //Chuyển sang Sheet SDKNSH
            v_obj_export_excel1.ChangeSheetExported(2);
            v_obj_export_excel1.FindAndReplaceCollection.Clear();
            //CExcelReport v_obj_export_excel2 = new CExcelReport("f500_DLDKLK_So_DKNSHTP_sdknsh.xls", 15, 2);
            v_obj_export_excel1.AddFindAndReplaceItem("<TO_CHUC_PHAT_HANH>", m_us_trai_phieu.strTEN_TO_CHUC_PHAT_HANH);
            v_obj_export_excel1.AddFindAndReplaceItem("<SO_CHUNG_NHAN_DKKD>","'"+v_us_to_chuc_phat_hanh.strCHUNG_NHAN_DKDN);
            v_obj_export_excel1.AddFindAndReplaceItem("<TRU_SO_CHINH>", v_us_to_chuc_phat_hanh.strDIA_CHI_TRU_SO_CHINH);
            v_obj_export_excel1.AddFindAndReplaceItem("<SO_DIEN_THOAI>", v_us_to_chuc_phat_hanh.strDIEN_THOAI);
            v_obj_export_excel1.AddFindAndReplaceItem("<SO_FAX>", v_us_to_chuc_phat_hanh.strFAX);
            v_obj_export_excel1.AddFindAndReplaceItem("<SO_TAI_KHOAN>", "'"+v_us_to_chuc_phat_hanh.strSO_TAI_KHOAN);
            v_obj_export_excel1.AddFindAndReplaceItem("<DIA_CHI>", v_us_to_chuc_phat_hanh.strMO_TAI_NGAN_HANG);
            v_obj_export_excel1.AddFindAndReplaceItem("<TEN_TRAI_PHIEU>", m_us_trai_phieu.strTEN_TRAI_PHIEU);
            //v_obj_export_excel2.AddFindAndReplaceItem("<LOAI_TRAI_PHIEU>", m_us_trai_phieu.strLOAI_TRAI_PHIEU);
            v_obj_export_excel1.AddFindAndReplaceItem("<MENH_GIA>", CIPConvert.ToStr(m_us_trai_phieu.dcMENH_GIA,"#,###")+" VNĐ/ Trái phiếu");
            v_obj_export_excel1.AddFindAndReplaceItem("<KY_HAN_TRAI_PHIEU>", m_us_trai_phieu.dcKY_HAN.ToString() + " " + m_us_trai_phieu.strDON_VI_KY_HAN);
            v_obj_export_excel1.AddFindAndReplaceItem("<LAI_SUAT>", m_us_trai_phieu.dcLAI_SUAT_DEFAULT);
            
            v_obj_export_excel1.AddFindAndReplaceItem("<PHUONG_THUC_TRA_LAI>", v_str_phuong_thuc_tra_lai);
            v_obj_export_excel1.AddFindAndReplaceItem("<NGAY_PHAT_HANH>", CIPConvert.ToStr(m_us_trai_phieu.datNGAY_PHAT_HANH,"dd/MM/yyyy"));
            v_obj_export_excel1.AddFindAndReplaceItem("<NGAY_DAO_HAN>", CIPConvert.ToStr(m_us_trai_phieu.datNGAY_DAO_HAN, "dd/MM/yyyy"));
            v_obj_export_excel1.AddFindAndReplaceItem("<SO_LUONG_TRAI_PHIEU>", CIPConvert.ToStr(m_us_trai_phieu.dcTONG_SL_PHAT_HANH,"#,###")+" Trái phiếu");
            v_obj_export_excel1.AddFindAndReplaceItem("<GIA_TRI_TRAI_PHIEU>", CIPConvert.ToStr(m_us_trai_phieu.dcTONG_GIA_TRI,"#,###")+" VNĐ");
            v_obj_export_excel1.FindAndReplace();

            //Chuyển sang Sheet DSNSHTP
            v_obj_export_excel1.ChangeSheetExported(3);            
            v_obj_export_excel1.FindAndReplaceCollection.Clear();
            //CExcelReport v_obj_export_excel3 = new CExcelReport("f500_DLDKLK_So_DKNSHTP_dsnshtp.xls", 8, 3);
            v_obj_export_excel1.AddFindAndReplaceItem("<TONG_SL_TP_SO_HUU>", CIPConvert.ToStr(v_dc_tong_so_du_tp,"#,###"));
            v_obj_export_excel1.AddFindAndReplaceItem("<TONG_GT_TP_SO_HUU>", CIPConvert.ToStr(v_dc_tong_gt_trai_phieu, "#,###"));   
            v_obj_export_excel1.FindAndReplace();
            v_obj_export_excel1.Export2ExcelWithoutFixedRows(m_fg, (int)e_col_Number.STT, m_fg.Cols.Count - 1, false);
            v_obj_export_excel1.ShowFile();
        }        
        #endregion
